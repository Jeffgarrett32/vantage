...
function FlipCard() {
  ...
  function handleClick() {
    ...
    return (
        ...
        <div id="question" className='grid grid-flow-row grid-cols-1 bg-neutral-100 border border-black rounded-t-md p-5 text-black text-lg font-mono justify-items-start mb-4'>
        ...
        <label className="form-check-label inline-block text-gray-800 text-lg" htmlFor="flexRadio1">
       ...
       <div className='form-check row-span-1 py-2'>
        ...
        <label className="form-check-label inline-block text-gray-800 text-lg" htmlFor="flexRadio2">
       ...
       <div className='form-check row-span-1 py-2'>
        ...
        <div className='row-span-2 flex w-1/2 bg-yellow-32-0/50 self-center items-center pt-3 pb-2 justify-start space-x-3'>
            <button onClick={() => handleClick()} className= 'bg-neutral-100 py-2 w-1/4 rounded-md border font-mono border-black transition-colors duration-500 transform inline hover:bg-neutral-700 focus:bg-amber-32 hover:text-white focus:text-white focus:shadow-lg hover:shadow-md text-center scale-105' type="submit"> Submit
                </button>
      ...
      <div id="explanation" className='p-4 text-black text-md font-mono justify-items-center mb-4 w-full items-center'>
        <p className='w-full text-2xl font-bold pb-4'>Business Email Compromise</p> <p className='text-lg'> That&apos;s right! A <span className='underline'>business email compromise</span> is a cyberattack designed to gain access to money or sensitive business information via email fraud. </p>
        </div>
        </div>
        <div className='flex w-1/2 h-1/3 bg-yellow-32-0/50 items-start ml-5 justify-start'>
            <button onClick={() => handleClick()} className= 'bg-neutral-100 py-2 w-2/4 rounded-md border border-black font-mono transition-colors duration-500 transform inline hover:bg-neutral-700 focus:bg-amber-32 hover:text-white focus:text-white focus:shadow-lg hover:shadow-md text-center scale-105' type="submit"> Return to Question
                </button>
