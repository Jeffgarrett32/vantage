...
function FlipCard() {
  ...
  function handleClick() {
    ...
    return (
        ...
        <div className={`grid grid-flow-row grid-cols-1 bg-yellow-32 border border-black rounded-sm w-4/6 justify-self-end pt-4 px-4 pb-2 ${flip ? "card flip front" : "card back"} `} >
       ...
       <div className='form-check row-span-1 py-2'>
        <input className="form-check-input appearance-none rounded-full h-4 w-4 border border-black bg-white text-yellow-32 checked:bg-white checked:border-black focus:bg-yellow-32 focus:ring-neutral-800 transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-3 cursor-pointer" type="radio" value={questions[currentQuestion].answerOptions[1].isCorrect}></input>
       ...
       <div className='form-check row-span-1 py-2'>
        <input className="form-check-input appearance-none rounded-full h-4 w-4 border border-b bg-white text-yellow-32 checked:bg-white checked:border-black focus:ring-neutral-800 transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-3 cursor-pointer" type="radio" value={questions[currentQuestion].answerOptions[3].isCorrect}></input>
        <label className="form-check-label inline-block text-gray-800" htmlFor="flexRadio2">
        ...
        <div className='row-span-2 flex w-1/2 bg-yellow-32-0/50 self-center items-center pt-3 pb-2 justify-start space-x-3'>
            <button onClick={() => handleClick()} className= 'bg-neutral-100 py-2 w-1/4 rounded-md border border-black transition-colors duration-500 transform inline hover:bg-neutral-700 focus:bg-yellow-32 hover:text-white focus:text-white focus:shadow-lg hover:shadow-md text-center scale-105' type="submit"> Submit
                </button>
                
        </div>
      </div>
      <div id="explainSide" className='card back bg-yellow-32 w-full h-full'> 
      ...
      <div id="explanation" className='p-4 text-black text-md font-jetbrains justify-items-center mb-4 w-full items-center'>
        ...
        <div className='flex w-1/2 h-1/3 bg-yellow-32-0/50 items-start ml-5 justify-start'>
            <button onClick={() => handleClick()} className= 'bg-neutral-100 py-2 w-2/4 rounded-md border border-black transition-colors duration-500 transform inline hover:bg-neutral-700 focus:bg-yellow-32 hover:text-white focus:text-white focus:shadow-lg hover:shadow-md text-center scale-105' type="submit"> Return to Question
                </button>
